...
class JoystickHandler:
    ...
    def get_bicopter_controls(self,start_yaw = 0, default_height = 0):
        ...
        self.tz = self.tz + -0.1*self.right_horizontal if self.b_state else start_yaw
    ...
    def get_outputs(self,start_yaw = 0, default_height = 0):
        """Get the output controls based on blimp type."""
        self.update_joy_params()
        if self.blimp_type == "bicopter":
            return self.get_bicopter_controls(start_yaw, default_height), self.y_state
